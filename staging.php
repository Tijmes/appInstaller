        ...
        <style>
			...
			* {
			...
			.cuecatch{
				...
				font-size:1.5vw; color:#fff; text-align:center;
                ...
                <div class="holder">
                    <div class="sheet" id="container">
                        ...
                        <div class="gpos" style="display:none;" id="topPanelWrap">
                            ...
                            <div style="height:10%;">
                                <div style="height:50%; top:27%; padding:5px; position:relative;">
                                    <object type="image/svg+xml" data="assets/img/close.svg" height="85%"></object>
                                    <div class="gpos">
                        ...
                        <div class="gpos" style="background:rgba(0,0,0,0.65); display:none;" id="colofonWrap">
                        	<div class="centerpos" style="width:75%; height:75%;">
                            	<div class="colofonTextPlace" id="colofonHold">
                                    ...
                                    <div style="position:absolute; top:15px; right:20px; width:22px; height:25px;">
                                        <object type="image/svg+xml" data="assets/img/close.svg" height="100%"></object>
                                        <div class="gpos">
